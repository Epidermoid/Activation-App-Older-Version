...
public class AlphabetDataDrawer : Editor
{
    ...
    private ReorderableList AlphabetHilightedList;
    ...
    private void OnEnable()
    {
        ...
        InitializeReordableList(ref AlphabetHilightedList, "AlphabetHilighted", "Alphabet Hilighted");
    ...
    public override void OnInspectorGUI()
    {
        ...
        AlphabetHilightedList.DoLayoutList();
