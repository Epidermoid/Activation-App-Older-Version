...
public class WordChecker : MonoBehaviour
{
    ...
    void Update()
    {
        if(_assignedPoints > 0 && Application.isEditor)
        {
            ...
            Debug.DrawRay(_rayDown.origin, _rayUp.direction * 4);
            Debug.DrawRay(_rayLeft.origin, _rayUp.direction * 4);
            Debug.DrawRay(_rayRight.origin, _rayUp.direction * 4);
            Debug.DrawRay(_rayDiagonalLeftUp.origin, _rayUp.direction * 4);
            Debug.DrawRay(_rayDiagonalLeftDown.origin, _rayUp.direction * 4);
            Debug.DrawRay(_rayDiagonalRightUp.origin, _rayUp.direction * 4);
            Debug.DrawRay(_rayDiagonalRightDown.origin, _rayUp.direction * 4);
        }
    }
